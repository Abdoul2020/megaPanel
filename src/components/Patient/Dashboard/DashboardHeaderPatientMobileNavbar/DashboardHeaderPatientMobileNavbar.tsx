...
export default function DashboardHeaderPatientMobileNavbar({}: Props) {
  ...
  const handleDashboardHeaderMobilePatientClose = () => {
    ...
    <div className="flex h-full max-w-[300px] flex-col items-center justify-between py-10">
      ...
      <div className="flex h-full w-full flex-col items-center justify-start gap-12">
        <Link
          to="/"
          className="w-full"
          onClick={handleDashboardHeaderMobilePatientClose}
        >
          <div
