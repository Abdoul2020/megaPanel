...
export default function ResetPassword({}: Props) {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (newPassword === "" || retypeNewPassword === "") {
      ...
      const body: AuthClientResetPasswordDto = {
        client_reset_password: newPassword,
        client_reset_retype_password: retypeNewPassword,
      };
      const resetPasswordToken = searchParams.get("resetpasswordtoken") || "";
      setLoader(true);
      setSubmitDisable(true);
      const response = await authClientResetPassword(body, resetPasswordToken);
      setLoader(false);
  ...
  return (
    <div className="relative flex h-screen w-full items-center justify-center bg-color-white-secondary px-10 py-20 pt-[170px] lg:px-0">
