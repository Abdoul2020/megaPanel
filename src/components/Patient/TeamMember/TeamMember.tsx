...
export default function TeamMember(props: Props) {
  ...
  return (
    <div className="flex flex-col items-start justify-start overflow-hidden rounded-[15px] bg-color-white">
      <div className="relative flex items-center justify-center bg-doctor-color-main py-5 pb-10">
        <img
          src={require("../../../assets/images/megaverse_logo_1.png")}
          alt=""
          className="w-2/3"
      ...
      <div className="flex w-full flex-col items-start justify-start gap-4">
        <div className="flex w-full items-center justify-center px-2 pt-14">
          <Link to={`/doctors/${props.expert?._id}`}>
            <div
        ...
        <div className="flex h-full w-full flex-col items-start justify-between gap-8">
          ...
          >
            <div className="flex items-center justify-center gap-1">
              ...
              />
              <h1 className="w-full overflow-ellipsis text-sm text-color-dark-primary opacity-80">
                {props.expert.expert_city ? props.expert.expert_city : ""}
              </h1>
            </div>
            <div className="flex items-center justify-center gap-1">
